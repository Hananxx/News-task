                    ...
                    <div class="p-4 border-b flex justify-between ">
                        ...
                        <div class="flex">
                            ...
                            {{Form::hidden('_method', 'PUT')}}
                              <label>
                                  <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 bg-gray-100 rounded-full p-1 hover:shadow-lg hover:text-blue-600 transition duration-300 ease-in-out" viewBox="0 0 20 20" fill="currentColor">
