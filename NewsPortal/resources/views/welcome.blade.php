...
<x-app-layout>
    <section class="pt-14 grid grid-cols-6 m-auto px-1 lg:px-3 gap-2 lg:gap-3">
        ...
        <div class="col-span-3 ">
            ...
            <h1 class="text-2xl font-bold">Latest Headlines</h1>
            <div class="mt-4 bg-white p-2 rounded-lg shadow-xl">
                ...
                <div class="px-3">
                    ...
                    <div class="flex justify-between">
                        ...
                        <div class=" mt-2">
                            <div class="px-2 p-1 text-xs font-bold bg-yellow-primary rounded-full text-yellow-500 flex items-center">
                ...
                @foreach($articles as $article)
                    @if($article->id != $articles[0]->id)
                        <div class="bg-white overflow-hidden rounded-lg shadow-xl">
                            <div class="h-24 rounded-lg bg-center bg-no-repeat bg-cover" style="background-image: url({{$article->cover_img}})"></div>
                            <div class="p-1 mt-1">
                                ...
                                <h5 class="text-lg font-medium capitalize">{{$article->title}}</h5>
